...
//   module: 'organization',
// })
export default class ChannelJoinModal extends Component {
  state = {
    msg:{
      orgName:'',
      channelName: '',
  ...
  //获取下拉框的数据
  getWorkspaces() {
    const {orgs_exit} = this.props.detail.item
    return orgs_exit.map(item => ({
      label: item,
      value: item,
    }))
  }
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Form.Item label={t('Seleted_Organization')} desc={t('Choose_a_organization')}>
          <Select
