...
describe('The Workspace Overview Page', function() {
  ...
  it('successfully loads', function() {
    ...
    cy.visit('/workspaces/e2e-Projects/roles')
  ...
  it('detail page', function() {
    ...
    cy.visit('/workspaces/e2e-Projects/roles/workspace-admin')

    cy.wait('@getWorkspace')
    cy.wait('@getWorkspaceRoleRules')

    cy.get('[data-Projects="rule-list"] > li').should('have.length', 7)

    cy.visit('/workspaces/e2e-Projects/roles/workspace-admin/users')
