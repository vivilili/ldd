...
describe('The Cluster Role Detail Page', function() {
  ...
  it('successfully loads', function() {
    ...
    cy.get('[data-Projects="detail-title"]').contains(name)
  })
  ...
  it('account detail base operation', function() {
    ...
    cy.get('[data-Projects="rule-list"] > li').should('have.length', 3)
    ...
    // edit
    {
      ...
      cy.get('[data-Projects="detail-desc"]').contains(
        `aaa ${formData.metadata.annotations['kubesphere.io/description']}`
      )
      cy.get('[data-Projects="rule-list"] > li').should('have.length', 4)
    }

    // delete
    {
      cy.get('[data-Projects="detail-delete"]').click()
