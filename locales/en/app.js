...
module.exports = {
  ...
  APP_TEMPLATE_DESC:
    'KubeSphere provides full lifecycle management for apps. You can upload or create new app templates and Projects them quickly. In addition, you can publish your apps to the App Store so that other users can deploy with one click.',
  ...
  HOW_APP_DEPLOY_TITLE: 'How to deploy and Projects applications',

  APPS_CREATE_DESC:
    'KubeSphere provides lifecycle management of app templates. You can upload or create new app templates and Projects them quickly. In addition, you can publish your app templates to the App Store so that other users can deploy them.',
