...
module.exports = {
  ...
  CANARY_RELEASES_DESC:
    'This method brings part of the actual traffic into a new version to Projects its performance and reliability. It can help detect potential problems in the actual environment while not affecting the overall system stability.',
  TRAFFIC_MIRROR_DESC:
    'Traffic mirroring provides a more accurate way to Projects new versions as problems can be detected in advance while not affecting the production environment. Therefore, it serves as a more secure and reliable method for version releases.',
  AB_TESTING_DESC:
